...
const stats = [
  { label: "Fuentes guardadas", value: "0", icon: Library, color: "text-primary" },
  { label: "Posts generados", value: "0", icon: FileText, color: "text-accent" },
];

const quickActions = [
  { label: "Añadir fuente", icon: Plus, path: "/library?new=true", description: "Sube un PDF, pega un link o escribe texto" },
    ...
    <div className="p-4 lg:p-8 space-y-8 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Bienvenido a PostFlow. Tu centro de creación de contenido.
        </p>
      </div>
      ...
      <Card className="border-dashed">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4 max-w-md">
            Sube PDFs, pega links de artículos, posts de LinkedIn o videos de YouTube para crear tu biblioteca de conocimiento.
          </p>
          <Button asChild>
            <Link to="/library?new=true">

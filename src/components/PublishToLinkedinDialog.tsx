...
function minDatetimeLocal() {
  ...
  // strip seconds + tz offset for input[type=datetime-local]
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Publica desde tu cuenta personal conectada. La publicación en página de empresa
            requiere aprobación de LinkedIn (próximamente).
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
              ...
              >
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs text-xs">
                    Requiere el scope <code>w_organization_social</code>, sujeto a aprobación
                    de LinkedIn. Disponible próximamente.
                  </TooltipContent>
                </Tooltip>
              </RadioGroup>
            </TooltipProvider>
          ...
          <p className="text-[11px] text-muted-foreground flex items-start gap-1.5">
            ...
            Las publicaciones salen de la cuenta de LinkedIn vinculada en el conector
            del proyecto, no de cada usuario individual.
          </p>
        </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={busy} className="gap-1.5">
            ...
            {busy ? "..." : mode === "now" ? "Publicar" : "Programar"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
